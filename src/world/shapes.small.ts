...
export const SMALL_BUILDERS: Record<ShapeIdSmall, () => BufferGeometry> = {
  ...
  캐러멜: () => assemble([
     ...
     */
    part(soft(0.64, 0.40, 0.50, 0.26), WHITE, [0, 0.20, 0], undefined, TILE.TOFFEE),
    /**
     * 윗면에 얹는 «부푼 판»도 해 봤는데 모따기를 0.34 로 올린 몸통과 겹쳐
     * **방석**이 됐다. 4.4cm 짜리에 부품을 더 얹을 자리는 없다 —
     * 모따기 0.26 짜리 판 하나로 「자른 조각」이 된다.
     */
  ]),
  /**

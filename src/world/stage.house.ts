...
export const HOUSE_PROPS: readonly StageProp[] = [
  ...
  { label: '우산꽂이', x: 0.92, z: -2.43, size: 0.48 },   // 사진 기준 우산이 기울어 발자국이 넓어져 남쪽 벽에서 2cm 뗐다
   ...
   */
  // 사진 기준 학습 책상 — 위 선반까지 합친 높이가 최장축이라 폭 0.7m, 무릎 자리가 0.40m 까지 트였다
  { label: '책상', x: -4.60, z: -7.28, size: 1.00, underPass: 0.40 },   // 북벽
  ...
  // 냉장고는 사진 비율(폭 : 깊이 = 1 : 1.17)로 넓고 깊어져 북벽을 4.4cm · 동벽을 1.5cm 뚫었다 — 앞으로 5cm, 서쪽으로 2cm
  { label: '냉장고', x: -1.51, z: -11.18, size: 1.55 },
  ...
  { label: '변기', x: 3.11, z: -9.60, size: 0.72, rotY: -Math.PI / 2 },  // 동벽 — 사진 비율로 탱크가 깊어져 2cm 당겼다
  // 남벽 — 세면대가 둥근 대야에서 네모 장이 되어 방향이 생겼다. 등(−z)을 남벽에 붙이려면 π 다
  { label: '세면대', x: 1.80, z: -8.96, size: 0.74, rotY: Math.PI },
  ...
  // 대나무 — 서벽, 자갈 어귀 밖
  // 잎을 창 모양으로 늘이면서 폭이 0.44 → 0.64 로 벌어져 서벽을 9.8cm 넘었다. 안으로 당긴다
  { label: '대나무', x: -3.32, z: 4.88, size: 1.90 },
  // 소나무(전정목) — 동벽
  // 잎덩이가 사진 폭(0.75)으로 넓어져 동쪽 담을 15cm 뚫었다 — 서쪽으로 15cm 옮긴다
  { label: '소나무', x: 3.20, z: 6.35, size: 1.45 },
  /**
   ...
   */
  // 사진의 퍼진 수관으로 발자국이 넓어져 북쪽 담을 9cm 뚫었다 — 앞으로 10cm 당긴다
  { label: '나무', x: -0.20, z: 8.75, size: 2.60 },
